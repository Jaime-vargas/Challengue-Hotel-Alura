 ...
 * @author jaime
 */
public class RegisteredGuestsPanel2 extends javax.swing.JPanel {
     ...
     */
    public RegisteredGuestsPanel2(InterfaceUtil interfaceUtil) {
    ...
    private void initComponents() {
        ...
        buttonNewGuest = new javax.swing.JButton();
        ...
        buttonNewGuest.setText("Register a new guest");
        buttonNewGuest.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        buttonNewGuest.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                buttonNewGuestActionPerformed(evt);
            }
        });
        panelData.add(buttonNewGuest, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 650, 203, 40));
    ...
    private void buttonNewGuestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonNewGuestActionPerformed
        interfaceUtil.showNewGuest();
    }//GEN-LAST:event_buttonNewGuestActionPerformed
    ...
    private javax.swing.JButton buttonNewGuest;
